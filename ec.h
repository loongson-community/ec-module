...
#define	BIT_USB2_FLAG_ON
#define	BIT_USB2_FLAG_OFF
...
/* registers we need and not supported by EC until now */
#define	REG_AUDIO_VOLUME_UP		
#define	REG_AUDIO_VOLUME_DOWN		
